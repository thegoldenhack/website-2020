...
import { getApplication, RSVPApplication } from "../../utils/API/index.js";
      ...
      return (
        <div>
          <Button
            ...
            type="button"
            variant="success"
            onClick={() => this.handleModalShowHide(this.state.rsvp, false)}
          >
            {this.state.text}
          </Button>
          ...
          <Modal show={this.state.showHide} centered>
            ...
            <Modal.Body>
              Are you attending The GoldenHack 2020 (virtually, of course!)?
            </Modal.Body>
            <Modal.Footer>
              <Button
                variant="success"
                onClick={() => this.handleModalShowHide(true, true)}
              >
                Going! :D
              </Button>
              <Button
                variant="danger"
                onClick={() => this.handleModalShowHide(false, true)}
              >
                Not Going :(
              </Button>
            </Modal.Footer>
